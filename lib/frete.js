...
// Quem mostra a notificação é o main.js do Electron (Notification nativa).
// Rodando só o servidor (testes), cai no console.
let notificar = (titulo, corpo) => console.log('[FRETE][NOTIF] ' + titulo + ' — ' + corpo.replace(/\n/g, ' | '));
